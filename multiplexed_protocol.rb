...
=begin
This is a multiplexed protocol delegate another Protocol like binary, 
compact etc which add service name in CALL or ONEWAY Message.
=end
module Thrift
  class MultiplexedProtocol < BaseProtocol

    def initialize(trans, service_name)
      @trans = super(trans)
      # @protocol = protocol
    ...
    # def initialize(service_name, protocol)
    #   @protocol = protocol
    #   @service_name = service_name
    # end
